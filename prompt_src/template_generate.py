...
if __name__ == '__main__':
    ...
    model_name = 't5-base' # 'Friends_template_t5_base/'
    beam_width = 10
    ...
    for personality in ['A','C','E','O','N']:
        ...
        df_data = pd.read_csv('../data/pan2015/Pan_' + personality + '_whole.tsv', sep='\t')
        ...
        with open('templates/'+model_name+'_Pan_'+personality+'_templates_top_'+str(beam_width)+'.txt', 'w') as f:
